...
ifeq ($(TARGET_CPU_VARIANT),$(filter $(TARGET_CPU_VARIANT),cortex-a15 cortex-a53 krait))
libm_arm_src_files += \
    arm/k_log2.S \
    arm/e_sqrt.S \
    arm/e_sqrtf.S \
    ...
    arm/s_cos_fast.S \
    arm/e_pow.S
libm_arm_cflags += -DLIBM_OPT_SIN_COS -DPRECISE_TRIGONOMETRIC -DKRAIT_NEON_OPTIMIZATION -fno-if-conversion
